...
ProjectileDefinition gProjectileDefinition[] = {  
	...
	{ ProjectileType::PROJECTILE_POISONPEA,     0,  20  }
};
...
void Projectile::ProjectileInitialize(int theX, int theY, int theRenderOrder, int theRow, ProjectileType theProjectileType)
{
	...
	if (mApp->mImpossiblemode == true) // IMPOSSIBLE MODE PROJECTILE DAMAGE
	{
		ProjectileDefinition gProjectileDefinition[] = {
			{ ProjectileType::PROJECTILE_PEA,           0,  10  },
			{ ProjectileType::PROJECTILE_SNOWPEA,       0,  10  },
			{ ProjectileType::PROJECTILE_CABBAGE,       0,  20  },
			{ ProjectileType::PROJECTILE_MELON,         0,  40  },
			{ ProjectileType::PROJECTILE_PUFF,          0,  10  },
			{ ProjectileType::PROJECTILE_WINTERMELON,   0,  40  },
			{ ProjectileType::PROJECTILE_FIREBALL,      0,  20  },
			{ ProjectileType::PROJECTILE_STAR,          0,  10  },
			{ ProjectileType::PROJECTILE_SPIKE,         0,  10  },
			{ ProjectileType::PROJECTILE_BASKETBALL,    0,  100 },
			{ ProjectileType::PROJECTILE_KERNEL,        0,  10  },
			{ ProjectileType::PROJECTILE_COBBIG,        0,  300 },
			{ ProjectileType::PROJECTILE_BUTTER,        0,  20  },
			{ ProjectileType::PROJECTILE_ZOMBIE_PEA,    0,  30  },
			{ ProjectileType::PROJECTILE_POISONPEA,     0,  10  }
		};
	}
...
bool Projectile::CantHitHighGround()
{
	...
	return (
		...
		mProjectileType == ProjectileType::PROJECTILE_POISONPEA ||
...
unsigned int Projectile::GetDamageFlags(Zombie* theZombie)
{
	...
	if (mProjectileType == ProjectileType::PROJECTILE_POISONPEA)
	{
...
void Projectile::Draw(Graphics* g)
{
	...
	else if (mProjectileType == ProjectileType::PROJECTILE_PEA || mProjectileType == ProjectileType::PROJECTILE_ZOMBIE_PEA || mProjectileType == ProjectileType::PROJECTILE_POISONPEA)
	{
...
void Projectile::DrawShadow(Graphics* g)
{
	...
	case ProjectileType::PROJECTILE_POISONPEA:
